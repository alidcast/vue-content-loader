...
var extractMetadata = require('./metadata-extracter').extractMetadata
// var metadataBlock = require('./metadata-extracter').metadataBlock
...
var renderVueTemplate = function (html, metadata = {}) {
  ...
  if (metadata) result = '<metadata>' + metadata + '</metadata>\n' + result
